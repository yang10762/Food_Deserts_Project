...
const stateColumns = [
  ...
  },
  {
    ...
    render: (text, row) => (<a href={`/states?state_name=${row.state}`}>{text}</a>)
  },
  {
    title: "Population",
  ...
  },
  {
    ...
    render: (text, row) => (<span>{row.total_HH_FD_status?.toLocaleString("en-US")}</span>)
  },
  {
...
class StatePage extends React.Component {
  ...
  componentDidMount() {
    ...
    getAllHSYearsForTopicTotal(
      this.state.selectedStateName, "Percent of adults aged 18 years and older who have an overweight classification").then((res) => {
        this.setState({ yearlyHSResultsForTopicTotal: res.results });
        this.setState({
          selectedTopicTotal:
    ...
    return (
      <div style={{ backgroundImage: `url(https://wallup.net/wp-content/uploads/2015/12/52687-landscape-desert.jpg)`, backgroundAttachment: "fixed",backgroundSize: "cover"}} >
          ...
          <Row style={{ marginLeft: 50 }}>
            ...
            <Col flex={2}>
              <FormGroup style={{ width: "10vw" }}>
                <Button style={{ marginTop: "4vh" }} onClick={this.updateSearchResultsName} >
                  Search Name
                </Button>
              </FormGroup>
            </Col>
            ...
            <Col flex={2}>
              <FormGroup style={{ width: "10vw" }}>
                <Button style={{ marginTop: "4vh" }} onClick={this.updateSearchResultsPopulation} >
                  Search Range
                </Button>
              </FormGroup>
            </Col>
        ...
        <div style={{ width: "70vw", margin: "0 auto", marginTop: "5vh" }}>
          ...
          <Table
            style={{ width: "100%", backgroundColor: "rgb(245, 238, 222, 0.8)"}}
        ...
        {Object.values(this.state.selectedStateDetails).every((x) => x !== null && typeof x !== "undefined") &&
          Object.values(this.state.yearlyHSResultsForTopicTotal).every((x) => x !== null && typeof x !== "undefined") &&
          this.state.selectedTopicTotal !== null && this.state.selectedTopicTotal !== "undefined" ? (
            ...
            items={[
              {
                label: `State Summary`,
                key: '1',
                children: <Card className="customCardColor" style={{ width: "70%" }}>
                <CardBody>
                  <Row align="center">
                    <h2>
              ...
              },
              {
                ...
                key: '2',
                children: <Card className="customCardColor" style={{ width: "80%" }}>
                <CardBody>
                  ...
                  <Row align="middle" justify="center">
                    <p>
                      ...
                      <span style={{ color: "green" }}>
                        {this.state.selectedStateDetails.demoFS.total?.toLocaleString("en-US")} {" "}
                      </span>
                    </p>
                  </Row>
                  ...
                  <Row align="middle" justify="center">
                    ...
                    <Progress multi style={{ width: "80%" }}>
                      <Progress
                        bar
                        value={(this.state.selectedStateDetails.demoFS.male / this.state.selectedStateDetails.demoFS.total) * 100}
                      >
                        {((this.state.selectedStateDetails.demoFS.male / this.state.selectedStateDetails.demoFS.total) * 100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"danger"}
                        value={(this.state.selectedStateDetails.demoFS.female / this.state.selectedStateDetails.demoFS.total) * 100}
                      >
                        {((this.state.selectedStateDetails.demoFS.female / this.state.selectedStateDetails.demoFS.total) * 100).toFixed(1)}%
                      </Progress>
                    </Progress>
                  </Row>
                  <br></br>
                  <Row gutter="10" align="middle" justify="center">
                    <p align="left">
                      ...
                      {this.state.selectedStateDetails.demoFS.male?.toLocaleString("en-US")}{" "}
                      males ~ ({((this.state.selectedStateDetails.demoFS.male /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-danger">Female</Badge> :{" "}
                      {this.state.selectedStateDetails.demoFS.female?.toLocaleString("en-US")}{" "}
                      females ~({((this.state.selectedStateDetails.demoFS.female /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                    </p>
                  </Row>
                  <br></br>
                  <Divider> </Divider>
                  ...
                  <Row align="middle" justify="center">
                    ...
                    <Progress multi style={{ width: "80%" }}>
                      <Progress
                        bar
                        theme={"primary"}
                        value={(this.state.selectedStateDetails.demoFS.age_0_9 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_0_9 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"secondary"}
                        value={(this.state.selectedStateDetails.demoFS.age_10_17 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_10_17 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"success"}
                        value={(this.state.selectedStateDetails.demoFS.age_18_29 / this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_18_29 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"danger"}
                        value={(this.state.selectedStateDetails.demoFS.age_30_39 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_30_39 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"warning"}
                        value={(this.state.selectedStateDetails.demoFS.age_40_49 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_40_49 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"info"}
                        value={(this.state.selectedStateDetails.demoFS.age_50_59 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_50_59 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"light"}
                        value={(this.state.selectedStateDetails.demoFS.age_60_69 /this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {((this.state.selectedStateDetails.demoFS.age_60_69 /this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                      <Progress
                        bar
                        theme={"dark"}
                        value={((this.state.selectedStateDetails.demoFS.age_70_79 + this.state.selectedStateDetails.demoFS.age_80_plus) /
                            this.state.selectedStateDetails.demoFS.total) *100}
                      >
                        {(((this.state.selectedStateDetails.demoFS.age_70_79 +this.state.selectedStateDetails.demoFS.age_80_plus) /
                            this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%
                      </Progress>
                    </Progress>
                  </Row>
                  <br></br>
                  <Row gutter="50" align="middle" justify="center">
                    <Col>
                      ...
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_0_9?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_0_9 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-secondary">Ages 10-17</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_10_17?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_10_17 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%) 
                      <br></br>
                      <Badge className="badge bg-success">Ages 18-29</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_18_29?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_18_29 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-danger">Ages 30-39</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_30_39?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_30_39 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                    </Col>
                    <Col>
                      <Badge className="badge bg-warning">Ages 40-49</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_40_49?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_40_49 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-info">Ages 50-59</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_50_59?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_50_59 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-light">Ages 60-69</Badge>
                      {" : "}{" "}{this.state.selectedStateDetails.demoFS.age_60_69?.toLocaleString("en-US")}{" "}
                      total ~ ({((this.state.selectedStateDetails.demoFS.age_60_69 /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)
                      <br></br>
                      <Badge className="badge bg-dark">Ages 70+</Badge> 
                      {" : "}{" "}{(this.state.selectedStateDetails.demoFS.age_70_79 +
                        this.state.selectedStateDetails.demoFS.age_80_plus)?.toLocaleString("en-US")}{" "}
                      total ~ ({(((this.state.selectedStateDetails.demoFS.age_70_79 + this.state.selectedStateDetails.demoFS.age_80_plus) /
                        this.state.selectedStateDetails.demoFS.total) *100).toFixed(1)}%)<br></br>
                    </Col>
                  </Row>
                  <br></br>
                </CardBody>
                ...
                <CardBody>
                  ...
                  <Row align="left">
                    ...
                    <Select
                      ...
                      onChange={(value) => {this.topicOnChange(this.state.selectedStateDetails.demoFS.state,value);}}
                    >
                  ...
                  <Row style={{ width: "100%" }} gutter="40" align="center">
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[0].percent} width={90}
                        strokeColor={{
                          "0%": "#FF0000",
                          "50%": "#FF7F00",
                          "100%": "#FFFF00",
                    ...
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[1].percent} width={90}
                        strokeColor={{
                          "0%": "#FFFF00",
                          "50%": "#7FFF00",
                          "100%": "#00FF00",
                    ...
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[2].percent} width={90}
                        strokeColor={{
                          "0%": "#00FF00",
                          "50%": "#00FF7F",
                          "100%": "#00FFFF",
                    ...
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[3].percent} width={90}
                        strokeColor={{
                          "0%": "#00FFFF",
                          "50%": "#007FFF",
                          "100%": "#0000FF",
                    ...
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[4].percent} width={90}
                        strokeColor={{
                          "0%": "#0000FF",
                          "50%": "#7F00FF",
                          "100%": "#FF00FF",
                    ...
                    <Col>
                      <ProgressAntd type="circle" percent={this.state.yearlyHSResultsForTopicTotal[5].percent} width={90}
                        strokeColor={{
                          "0%": "#FF00FF",
                          "50%": "#FF007F",
                          "100%": "#FF0000",
              ...
              },
              {
                ...
                <CardBody>
                  ...
                  <Carousel dots={true} draggable={true} ref={carouselRef} >
                    ...
                    <div>
                      <img
                        src={this.state.selectedStateDetails.detail.skyline_background}
                        referrerpolicy="no-referrer"
                        alt={null}
                        className="center"
                        style={{ width: "90%" }}
                  ...
                  <br></br>
                  <Row align="middle" justify="center">
                    <Button style={{ backgroundColor: "orange" }} onClick={() => carouselRef.current.goTo(0)} >
                      Landscape View
                    </Button>
                    <Button style={{ backgroundColor: "orange", marginLeft: "15px" }} onClick={() => carouselRef.current.goTo(1)} >
                      Skyline View
                    </Button>
                  </Row>
                </CardBody>
